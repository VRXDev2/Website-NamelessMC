					...
					<div class="action-bar-buttons">
						<div class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-end">
								...
								<li>
									<a href="{$SITE_HOME}suggestions{($SITE_HOME|strstr:'?') ? '&' : '?'}sort=newest" class="dropdown-item">{$NEWEST}</a>
								</li>
								<li>
									<a href="{$SITE_HOME}suggestions{($SITE_HOME|strstr:'?') ? '&' : '?'}sort=recent-activity" class="dropdown-item">{$RECENT_ACTIVITY}</a>
								</li>
								<li>
									<a href="{$SITE_HOME}suggestions{($SITE_HOME|strstr:'?') ? '&' : '?'}sort=likes" class="dropdown-item">{$LIKES}</a>
								</li>
							</ul>
						</div>
						<a href="{$NEW_SUGGESTION_LINK}" class="btn btn-primary btn-sm" data-request-modal="new-suggestion">{$NEW_SUGGESTION}</a>
