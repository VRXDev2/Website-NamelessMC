...
<div class="lithium-panel-content">
	...
	<div class="lithium-panel-body">
		<form>
			...
			createInput('siteTitle', 'text', [
				'label' => 'Site Title',
				'value' => SITE_NAME
			]);

			createInput('siteDescription', 'textarea', [
				'label' => 'Site Description',
				'value' => 'An official website of ' . SITE_NAME . ' community.'
			]);

			createInput('pageTitleFormat', 'text', [
				'label' => 'Page Title Format',
				'value' => '[pageTitle] &bull; [siteName]'
			]);

			createInput('siteIcon', 'image', [
				'label' => 'Site Icon',
