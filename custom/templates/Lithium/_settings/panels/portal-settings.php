...
<div class="lithium-panel-content">
	...
	<div class="lithium-panel-body">
		<form>
			...
			createInput('portalBackground', 'image', [
			...
			createInput('enablePortalParticles', 'switch', [
				'label' => 'Enable Particles',
				'value' => '0'
			]);

			createInput('portalParticlesColor', 'color', [
			...
			createInput('portalLogoHeight', 'textShort', [
				'label' => 'Logo Height',
				'value' => '200px'
			]);

			createInput('enablePortalLogoAnimation', 'switch', [
				'label' => 'Enable Logo Animation',
				'value' => '1'
			]);

			createInput('portalButtons', 'groups', [
				'label' => 'Portal Button',
				'value' => [
					'title' => [
						'Home',
